...
public:
    ...
    static int  GifSetLoadingDelay(lua_State*);
    static int  GifGetLoadedFrameCount(lua_State*);
    ...
    static int  GifGetLoadingDelay(lua_State*);
    static int  IsGifPlaying(lua_State*);
    static int  IsGifLoading(lua_State*);
    static int  IsGifLoaded(lua_State*);
};
