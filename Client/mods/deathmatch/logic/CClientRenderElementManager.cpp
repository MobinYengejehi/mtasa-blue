...
//
////////////////////////////////////////////////////////////////
CClientGif* CClientRenderElementManager::CreateGif(uint width, uint height,unsigned char* thumbnail)
{
    // Create the item
    ...
    // Create the element
    CClientGif* pGifElement = new CClientGif(m_pClientManager, INVALID_ELEMENT_ID, pGifItem,thumbnail);
